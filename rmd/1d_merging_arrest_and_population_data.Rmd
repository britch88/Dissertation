...
#Load the data sets
```{r data}
arrests <- readRDS(here::here("rda/total_arrests_by_county.rds")) #145,380 records
population <- readRDS(here::here("rda/population_wide.rds")) #158,286 records
...
```{r}
saveRDS(combo1, file = file.path(rdadir, "combined_populations_arrests.rds"))
```

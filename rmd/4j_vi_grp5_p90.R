...
# load the data set
dat <-readRDS(here::here("rda","analysis_vi_2017_90th.rds"))

# Specify learners
# Insert both X and A predictors
predset_x01 <- c(
  "bankrate2017.na",                    "bankrate2017.gtp90",            
  "poverty_2017.ltp10",                           
  "unemployment_rate_2017.ltp10",               
  "median_household_income_2017.gtp90",   
  "some_college_2017.gtp90",                 
  "hs_grad_2017.gtp90",                         
  "broadband_2017.gtp90",               
  "disconnected.2017.na",               "disconnected.2017.ltp10",                  
  "food.2017.na",                       "food.2017.gtp90",       
  "violent.2017.na",                    "violent.2017.ltp10",             
  "segregation.2017.na",                "segregation.2017.ltp10",                      
  "pcp_2017.gtp90",                        
  "lbw_2017.ltp10",                        
  "income_ratio_2017.ltp10",              
  "uninsured_2017.ltp10",                      
  ...
  "prek_2017.gtp90",        
  "rentburden_2017.ltp10",                        
  "deaths_2017.ltp10",                    
  "incarcerated_2017.ltp10",       
  "voting_2017.gtp90",                        
  "volunteer_2017.gtp90",                  
...
dat2 <- dat %>% select(predset_x01,Grp5)
...
dat3 <- drop_na(dat2,c(predset_x01, "Grp5"))
# 230 records deleted
...
#                          broadband_2017.ltp25 , broadband_2017.gtp75 ,  Grp5 ) %>% 
#   mutate_if(is.logical,as.numeric)

#-----------------------------------#
outcome_variable <- "Grp5" # Insert outcome variable
...
saveRDS(vi_est_summary, here::here("rda/vi results","vi_grp5_p90.rds"))

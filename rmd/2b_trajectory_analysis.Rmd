...
#loop for n.cluster = c(1,2) and p.poly = c(1,2,3)
```{r}
# GBTM CLUSTERING: crimCV

## set the grid of models to evaluate
  # Set: 
    n.cluster = c(1,2) #,2,3,4,5,6) # 1.which k's to evaluate, 
...
aicng1t2 <- points.for.AIC.plot
bicng1t2 <- points.for.BIC.plot
cvng1t2 <- points.for.cv.plot
  
saveRDS(aicng1t2,"rda/Intermediate/aicng1t2.rds")
saveRDS(bicng1t2,"rda/Intermediate/bicng1t2.rds")
saveRDS(cvng1t2,"rda/Intermediate/cvng1t2.rds")

```
  
#loop for n.cluster = c(3,4) and p.poly = c(1,2,3)
```{r}
# GBTM CLUSTERING: crimCV

## set the grid of models to evaluate
  # Set: 
    n.cluster = c(3,4) #,2,3,4,5,6) # 1.which k's to evaluate, 
    p.poly = c(1,2,3) # 2. which p's to evaluate, 
    rcv = F # 3. do you want to run cross validation? T/F
...
#Adding code to store values
aicng3t4 <- points.for.AIC.plot
bicng3t4 <- points.for.BIC.plot
cvng3t4 <- points.for.cv.plot
  
saveRDS(aicng3t4,"rda/Intermediate/aicng3t4.rds")
saveRDS(bicng3t4,"rda/Intermediate/bicng3t4.rds")
saveRDS(cvng3t4,"rda/Intermediate/cvng3t4.rds")

```  
  
  
#loop for n.cluster = c(5) and p.poly = c(1,2,3)
```{r}
# GBTM CLUSTERING: crimCV

## set the grid of models to evaluate
  # Set: 
    n.cluster = c(5) #,2,3,4,5,6) # 1.which k's to evaluate, 
    p.poly = c(1,2,3) # 2. which p's to evaluate, 
    rcv = F # 3. do you want to run cross validation? T/F
...
#Adding code to store values
aicng5 <- points.for.AIC.plot
bicng5 <- points.for.BIC.plot
cvng5 <- points.for.cv.plot
  
saveRDS(aicng5,"rda/Intermediate/aicng5.rds")
saveRDS(bicng5,"rda/Intermediate/bicng5.rds")
saveRDS(cvng5,"rda/Intermediate/cvng5.rds")

...
# combining models ----
df_list<- list(results.adv1, results.adv2, results.dis1, results.dis2)

all.mods <- df_list %>% reduce(full_join, by='rowname')


# Save and export all models ----
saveRDS(all.mods, here::here("rda","subgroup_physical230919.rds"))


write.csv(all.mods, here::here("Output","subgroup_physical230919.csv"))

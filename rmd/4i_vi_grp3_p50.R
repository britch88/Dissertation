...
dat2 <- dat %>% select(predset_x01,Grp3)
...
dat3 <- drop_na(dat2,c(predset_x01, "Grp3"))
# 230 records deleted
...
#                          broadband_2017.ltp25 , broadband_2017.gtp75 ,  Grp3 ) %>% 
#   mutate_if(is.logical,as.numeric)

#-----------------------------------#
outcome_variable <- "Grp3" # Insert outcome variable
...
saveRDS(vi_est_summary, here::here("rda/vi results","vi_grp3_p50.rds"))

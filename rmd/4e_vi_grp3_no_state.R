...
vi_est_grp3_summary <- vi_est_grp3 %>% 
...
head(vi_est_grp3_summary)

saveRDS(vi_est_grp3_summary, here::here("rda/vi results","vi_grp3_no_state.rds"))
...
outcome <- unique(vi_est_grp3_summary$outcome)
predictorLabels <- paste0(
  vi_est_grp3_summary$predictor, "\n",
  vi_est_grp3_summary$lowValue, " to ",
  vi_est_grp3_summary$highValue
)
# Plot variable importance 
ggplot2::ggplot(vi_est_grp3_summary,

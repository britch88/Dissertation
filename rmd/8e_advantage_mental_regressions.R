...
hist(advantage$`Poor mental health days raw value`, breaks=100)
...
saveRDS(all.mods.poor.fair, here::here("rda","advantaged_health_results_mental.rds"))


write.csv(all.mods.poor.fair, here::here("Output","advantaged_health_results_mental.csv"))

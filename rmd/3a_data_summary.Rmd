...
nationaldat <- summarydat2 %>%  summarise(total.arrests = sum(c_young_adult_tot), 
                                          total.pop = sum(n_young_adults),

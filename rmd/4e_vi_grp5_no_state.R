...
vi_est_grp5_summary <- vi_est_grp5 %>% 
...
head(vi_est_grp5_summary)

saveRDS(vi_est_grp5_summary, here::here("rda/vi results","vi_grp5_no_state.rds"))
...
outcome <- unique(vi_est_grp5_summary$outcome)
predictorLabels <- paste0(
  vi_est_grp5_summary$predictor, "\n",
  vi_est_grp5_summary$lowValue, " to ",
  vi_est_grp5_summary$highValue
)
# Plot variable importance 
ggplot2::ggplot(vi_est_grp5_summary,

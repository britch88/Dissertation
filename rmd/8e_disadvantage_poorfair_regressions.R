...
saveRDS(all.mods.poor.fair, here::here("rda","disadvantaged_health_results_poor_fair.rds"))


write.csv(all.mods.poor.fair, here::here("Output","disadvantaged_health_results_poor_fair.csv"))

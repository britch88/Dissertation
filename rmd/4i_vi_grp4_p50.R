...
# load the data set
dat <-readRDS(here::here("rda","analysis_vi_2017_50th.rds"))

# Specify learners
# Insert both X and A predictors
predset_x01 <- c(
  "bankrate2017.na",                    "bankrate2017.gtp50",            
  "poverty_2017.ltp50",                           
  "unemployment_rate_2017.ltp50",               
  "median_household_income_2017.gtp50",   
  "some_college_2017.gtp50",                 
  "hs_grad_2017.gtp50",                         
  "broadband_2017.gtp50",               
  "disconnected.2017.na",               "disconnected.2017.ltp50",                  
  "food.2017.na",                       "food.2017.gtp50",       
  "violent.2017.na",                    "violent.2017.ltp50",             
  "segregation.2017.na",                "segregation.2017.ltp50",                      
  "pcp_2017.gtp50",                        
  "lbw_2017.ltp50",                        
  "income_ratio_2017.ltp50",              
  "uninsured_2017.ltp50",                      
  ...
  "prek_2017.gtp50",        
  "rentburden_2017.ltp50",                        
  "deaths_2017.ltp50",                    
  "incarcerated_2017.ltp50",       
  "voting_2017.gtp50",                        
  "volunteer_2017.gtp50",                  
...
dat2 <- dat %>% select(predset_x01,Grp4)
...
dat3 <- drop_na(dat2,c(predset_x01, "Grp4"))
# 230 records deleted
...
#                          broadband_2017.ltp25 , broadband_2017.gtp75 ,  Grp4 ) %>% 
#   mutate_if(is.logical,as.numeric)

#-----------------------------------#
outcome_variable <- "Grp4" # Insert outcome variable
continuous_variables <- c() # Insert continuous variable
factor_variables <- predset_x01 # Insert factor variable
#-----------------------------------#

lows <-rep(c(0),each=60)
highs <-rep(c(1),each=60)
...
saveRDS(vi_est_summary, here::here("rda/vi results","vi_grp4_p50.rds"))
...
outcome <- unique(vi_est_summary$outcome)
predictorLabels <- paste0(
  vi_est_summary$predictor, "\n",
  vi_est_summary$lowValue, " to ",
  vi_est_summary$highValue
)
# Plot variable importance 
ggplot2::ggplot(vi_est_summary,

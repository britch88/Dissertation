...
saveRDS(all.mods, here::here("rda","averaged_subgroup_poorfair.csv"))


write.csv(all.mods, "/data/share/xproject/Training/Practice/henderson/Dissertation/Output/averaged_subgroup_poorfair.csv")

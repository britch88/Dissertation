...
hist(advantage$`Poor or fair health raw value`, breaks=100)
...
saveRDS(all.mods.poor.fair, here::here("rda","advantaged_lme_poorfair.rds"))


write.csv(all.mods.poor.fair, here::here("Output","advantaged_lme_poorfair.csv"))

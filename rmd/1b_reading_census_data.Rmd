...
dat2 <- filter(dat1, age > 17) %>% select(year, state, state.fips, county.fips, age, population)
...
#Create young adult population, grouped by county and year



#Create older adult population, group by county and year



#Create total adult population, group by county and year

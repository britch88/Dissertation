...
There are `r count(filter(dat6,is.na(State)==0 & is.na(state)==1))` observations that are in the population data set but not in the FIPS crosswalk.
...
save(dat5, file = file.path(rdadir, "population_wide.RData"))
```

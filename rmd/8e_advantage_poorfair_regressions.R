...
# Running Models: Poor or fair health days    ----
...
saveRDS(all.mods.poor.fair, here::here("rda","advantaged_health_results_poor_fair.rds"))


write.csv(all.mods.poor.fair, here::here("Output","advantaged_health_results_poor_fair.csv"))

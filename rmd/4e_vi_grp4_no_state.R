...
vi_est_grp4_summary <- vi_est_grp4 %>% 
...
head(vi_est_grp4_summary)

saveRDS(vi_est_grp4_summary, here::here("rda/vi results","vi_grp4_no_state.rds"))
...
outcome <- unique(vi_est_grp4_summary$outcome)
predictorLabels <- paste0(
  vi_est_grp4_summary$predictor, "\n",
  vi_est_grp4_summary$lowValue, " to ",
  vi_est_grp4_summary$highValue
)
# Plot variable importance 
ggplot2::ggplot(vi_est_grp4_summary,
